...
namespace App\Livewire\FlujoDeVenta;
...
class VidaUtilDeUnFlujo extends Component
{
    ...
    public function aplicarFiltros(): void
    {
        ...
        $this->cargarAnalitica();
        $this->dispatch('flujo-analytics-updated', $this->datosGraficos());
    }
    ...
    public function guardarUmbrales(): void
    {
        ...
        $this->cargarAnalitica();
        $this->dispatch('flujo-analytics-updated', $this->datosGraficos());
        $this->dispatch('flujo-thresholds-saved');
    }
    ...
    public function verFlujo(int $flujoId): void
    {
        ...
        if (!$flujo) {
            $this->dispatch('flujo-analytics-error', mensaje: 'El flujo solicitado ya no existe.');
            return;
        }
        ...
        $this->dispatch('flujo-analytics-detail-ready');
    }
