...
namespace App\Livewire\CuentasPorCobrar;
...
class ListadoFacturas extends Component
{
    ...
    public function listarFacturasCobrar(){
        ...
        try {
            ...
            FORMAT(CASE WHEN factura.tipo_venta_id = 3 THEN 0 ELSE isv END,2) as isv,
            FORMAT(CASE WHEN factura.tipo_venta_id = 3 THEN sub_total ELSE total END,2) as total,
            factura.credito,
