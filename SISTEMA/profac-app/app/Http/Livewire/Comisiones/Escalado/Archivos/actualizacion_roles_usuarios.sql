...
(89, 'reporte/productos-sin-imagenes', 'Productos sin imágenes', 29, 8, 1, 'fas fa-image', '2025-12-16 18:30:00', '2025-12-16 18:30:00'),
...
(261, 1, 89, '2025-12-16 18:30:00', '2025-12-16 18:30:00'),
(262, 4, 89, '2025-12-16 18:30:00', '2025-12-16 18:30:00'),
(263, 5, 89, '2025-12-16 18:30:00', '2025-12-16 18:30:00'),
(264, 8, 89, '2025-12-16 18:30:00', '2025-12-16 18:30:00'),
(265, 7, 89, '2025-12-16 18:30:00', '2025-12-16 18:30:00');
...
CROSS JOIN (
    SELECT DATE('2026-01-01') AS mes_comision UNION ALL
    SELECT DATE('2026-02-01') UNION ALL
    SELECT DATE('2026-03-01') UNION ALL
    SELECT DATE('2026-04-01') UNION ALL
    SELECT DATE('2026-05-01') UNION ALL
    SELECT DATE('2026-06-01') UNION ALL
    SELECT DATE('2026-07-01') UNION ALL
    SELECT DATE('2026-08-01') UNION ALL
    SELECT DATE('2026-09-01') UNION ALL
    SELECT DATE('2026-10-01') UNION ALL
    SELECT DATE('2026-11-01') UNION ALL
    SELECT DATE('2026-12-01')
) meses
