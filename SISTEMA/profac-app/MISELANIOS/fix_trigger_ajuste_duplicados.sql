-- ============================================================
-- FIX: Ajustes duplicados en cardex
-- Causa: el trigger dispara FOR EACH ROW en log_translado.
--   Si un ajuste tiene N productos → N filas en log_translado
--   → el trigger corre N veces → inserta todos los productos
--     del ajuste N veces en cardex.
-- Solución: agregar AND NOT EXISTS para evitar insertar si ya
--   existe una fila con el mismo ajuste + producto + sección.
-- ============================================================
