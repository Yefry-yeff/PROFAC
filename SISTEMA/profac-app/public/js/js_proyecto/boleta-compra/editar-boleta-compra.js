 ...
 * Archivo: editar-boleta-compra.js
 */
...
function guardarEdicionBoleta() {
    ...
    Swal.fire({
        ...
        text: 'Se actualizará la boleta de compra.',
        icon: 'question',
        ...
        axios.post('/boleta/compra/actualizar', {
            id:         id,
            cliente:    cliente,
            direccion:  direccion,
            fecha:      fecha,
            ...
            var msg = 'Error al actualizar la boleta de compra.';
...
// ── Imprimir boleta editada ───────────────────────────────────────────────────
function imprimirBoletaEdit(tipo) {
    if (!idBoletaGuardada) {
