...
function cargarTabla() {
    ...
    tblVentasCobros = $('#tbl_ventas_cobros').DataTable({
        ...
        columns: [
            ...
            /* #13 */ { data: 'detalle_abonos',     className: 'text-left',   defaultContent: 'No aplica' },
            /* #14 */ { data: 'sub_total',          className: 'text-right',  render: function(v) { return fmtLps(v); } },
            /* #15 */ { data: 'isv',                className: 'text-right',  render: function(v) { return fmtLps(v); } },
            /* #16 */ { data: 'total',              className: 'text-right',  render: function(v) { return fmtLps(v); } },
            /* #17 */ { data: 'saldo_pendiente',    className: 'text-right readonly-col', render: function(v) { return fmtLps(v); } },
            /* #18 */ { data: 'monto_pagado',       className: 'text-right',  render: function(v) { return fmtLps(v); } },
            /* #19 */ { data: 'monto_retencion',    className: 'text-right',  render: function(v) { return fmtLpsZero(v); } },
            /* #20 */ { data: 'numero_retencion',   className: 'text-left',   defaultContent: 'No aplica' },
            /* #21 */ { data: 'fecha_venta',        className: 'text-center' },
            /* #22 */ { data: 'fecha_vencimiento',  className: 'text-center' },
            /* #23 */ { data: 'dias_vencidos',      className: 'text-center readonly-col', render: function(v) { return v + ' días'; } },
            /* #24 */ { data: 'creditos_vencidos',  className: 'text-center',  render: renderEstado },
            /* #25 */ { data: 'fecha_pago',         className: 'text-center' },
            /* #26 */ { data: 'forma_pago',         className: 'text-left'  },
            /* #27 */ { data: 'cuenta_banco',       className: 'text-left'  },
            /* #28 */ { data: 'fecha_entrega',      className: 'text-center' },
            /* #29 */ { data: 'recibo',             className: 'text-center' },
        ],
