...
function cargarTabla() {
    ...
    tblVentasCobros = $('#tbl_ventas_cobros').DataTable({
        ...
        columns: [
            ...
            /* #18 */ { data: 'monto_retencion',    className: 'text-right',  render: function(v) { return fmtLpsZero(v); } },
            /* #19 */ { data: 'numero_retencion',   className: 'text-left',   defaultContent: 'No aplica' },
            /* #20 */ { data: 'fecha_venta',        className: 'text-center' },
            /* #21 */ { data: 'fecha_vencimiento',  className: 'text-center' },
            /* #22 */ { data: 'dias_vencidos',      className: 'text-center readonly-col', render: function(v) { return v + ' días'; } },
            /* #23 */ { data: 'creditos_vencidos',  className: 'text-center',  render: renderEstado },
            /* #24 */ { data: 'fecha_pago',         className: 'text-center' },
            /* #25 */ { data: 'forma_pago',         className: 'text-left'  },
            /* #26 */ { data: 'cuenta_banco',       className: 'text-left'  },
            /* #27 */ { data: 'fecha_entrega',      className: 'text-center' },
            /* #28 */ { data: 'recibo',             className: 'text-center' },
        ],
