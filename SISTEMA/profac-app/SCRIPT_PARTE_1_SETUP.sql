...
-- Ejecuta esta primera, luego SCRIPT_PARTE_2_RESULTADOS.sql
-- ============================================================================
...
-- Confirma que las tablas están listas
SELECT 'PARTE 1 COMPLETADA - Tablas intermedias creadas correctamente' AS status;
SELECT COUNT(*) AS registros_totales_factura_rol FROM tmp_totales_factura_rol;
