<div>
    ...
    <div class="row wrapper border-bottom white-bg page-heading d-flex align-items-center">
        <div class="col-lg-12">
            <h2><i class="fa fa-archive mr-2" style="color:#e67e22"></i>Cardex General</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Inicio</a></li>
                <li class="breadcrumb-item active"><strong>Cardex General</strong></li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="cdx-card">
                    <div class="cdx-card-header">
                        <h5><i class="fa fa-filter"></i> Rango de Fechas</h5>
                    </div>
                    <div class="cdx-card-body">
                        <div class="row">
                            <div class="col-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label class="font-weight-bold small">Fecha de inicio <span class="text-danger">*</span></label>
                                    <input class="form-control" type="date" id="fecha_inicio" name="fecha_inicio" value="{{date('Y-m-01')}}">
                                </div>
                            </div>
                            <div class="col-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label class="font-weight-bold small">Fecha final <span class="text-danger">*</span></label>
