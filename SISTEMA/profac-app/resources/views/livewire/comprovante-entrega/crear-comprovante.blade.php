                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 ">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="codigoProductoCrearComprobante" class="form-control"
                                        ...
                                        <small id="productoSeleccionadoCrearComprobante" class="text-success font-weight-bold mt-1 d-block d-none"></small>
