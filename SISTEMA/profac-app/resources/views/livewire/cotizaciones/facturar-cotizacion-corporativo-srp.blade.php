                            ...
                            <div class="row mt-4">
                                <div class="col-12 col-md-4 col-lg-4 col-xl-4">
                                    ...
                                    <div class="input-group mt-1">
                                        <input type="text" id="bsp_display_facturaCotiCorpSrp" class="form-control"
                                               readonly placeholder="-- Ningún producto seleccionado --"
                                               style="background:#fff; cursor:pointer;"
                                               onclick="window['abrirBuscador_buscadorProductoFacturaCotiCorpSrp']('')">
                                    ...
                                    function alSeleccionarProductoFacturaCotiCorpSrp(producto) {
                                        document.getElementById('bsp_display_facturaCotiCorpSrp').value =
