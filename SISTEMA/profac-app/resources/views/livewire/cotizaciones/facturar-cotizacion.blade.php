<div>
                        ...
                        <form onkeydown="return event.key != 'Enter';" autocomplete="off" id="crear_venta"
                            ...
                            <div class="row  mt-4 mb-4">
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                    <label for="vendedor">Asesor Comercial:<span class="text-danger">*</span>
                                    </label>
                            ...
                            <div class="row mt-4">
                                <div class="col-12 col-md-4 col-lg-4 col-xl-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="codigoProductoFacturaCoti" class="form-control"
                                               placeholder="ID o nombre del producto…" autocomplete="off"
                                               onkeydown="if(event.key==='Enter'){buscarPorCodigoFacturaCoti(this.value);return false;}">
                                        <div class="input-group-append">
                                            <button type="button" class="btn btn-primary" title="Buscar producto"
                                                    onclick="limpiarProductoFacturaCoti(); window['abrirBuscador_buscadorProductoFacturaCoti'](document.getElementById('codigoProductoFacturaCoti').value||'')">
                                                <i class="fa fa-search"></i>
                                            </button>
                                        </div>
                                    </div>
                                    <small id="productoSeleccionadoFacturaCoti" class="text-success font-weight-bold mt-1 d-block d-none"></small>
                                    ...
                                    @push('scripts')
                                    <script>
                                    function limpiarProductoFacturaCoti() {
                                    ...
                                    function alSeleccionarProductoFacturaCoti(producto) {
                                        ...
                                        document.getElementById('codigoProductoFacturaCoti').value = producto.nombre;
                                        var label = document.getElementById('productoSeleccionadoFacturaCoti');
                                    ...
                                    function buscarPorCodigoFacturaCoti(cod) {
                                        cod = String(cod).trim();
                                        if (!cod) { window['abrirBuscador_buscadorProductoFacturaCoti'](''); return; }
                                        axios.get('/productos/buscar', { params: { q: cod, page: 1 } })
                                            .then(function(r) {
                                                ...
                                                if (exact) { alSeleccionarProductoFacturaCoti(exact); }
    ...
    @push('scripts')
        ...
        <script src="{{ asset('js/js_proyecto/cotizaciones/facturar-cotizacion.js') }}"></script>
    @endpush
</div>
