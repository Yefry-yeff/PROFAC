<div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="exampleModalLabel">Registro de Numero Orden Compra - {{ $nombreTipo }}</h3>
    ...
    @push('scripts')
        <script>
            // Configuración de URLs por tipo
            var urlsPorTipo = {
                corporativo: {
                    listar: '/coorporativo/ordenCompra/listar',
                    clientes: '/coorporativo/ordenCompra/clientes',
                    clientesEditar: '/estatal/ordenes/listar/clientes',
                    guardar: '/estatal/ordenes/guardar',
                    datos: '/estatal/ordenes/datos',
                    editar: '/estatal/ordenes/editar',
                    desactivar: '/estatal/ordenes/desactivar'
                },
                estatal: {
                    listar: '/estatal/ordenes/listar',
                    clientes: '/estatal/ordenes/listar/clientes',
                    clientesEditar: '/estatal/ordenes/listar/clientes',
                    guardar: '/estatal/ordenes/guardar',
                    datos: '/estatal/ordenes/datos',
                    editar: '/estatal/ordenes/editar',
            ...
            var urls = urlsPorTipo[tipoCliente] || urlsPorTipo['estatal'];
            ...
            function desactivarNumOrdenCompra(id){
                let data = {id:id}
                axios.post(urls.desactivar, data)
                .then( response =>{
                    $('#tbl_numero_ordenes_listar').DataTable().ajax.reload();
                })
                .catch( err=>{
