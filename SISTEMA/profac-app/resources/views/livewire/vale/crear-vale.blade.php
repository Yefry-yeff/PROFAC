                        ...
                        <div id='${numeroInputs}' class="row no-gutters">
                                            ...
                                            <div class="form-group col-12 col-sm-12 col-md-1 col-lg-1 col-xl-1">
                                                ...
                                                <input type="number" placeholder="Precio Unidad" id="precio${numeroInputs}"
                                                    name="precio${numeroInputs}" value="${producto.precio_unidad}" class="form-control" readonly  data-parsley-required step="any"
                                                    autocomplete="off" min="${producto.precio_unidad}" onchange="calcularTotales(precio${numeroInputs},cantidad${numeroInputs},${producto.isv},unidad${numeroInputs},${numeroInputs},restaInventario${numeroInputs})">
                                            </div>
