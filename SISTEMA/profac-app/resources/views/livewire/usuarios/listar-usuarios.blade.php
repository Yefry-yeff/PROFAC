                        ...
                        <form id="userEditForm" name="userEditForm" data-parsley-validate>
                            <div class="row" id="row_datos">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="password" id="nueva_contrasena" name="nueva_contrasena" minlength="8" placeholder="Mínimo 8 caracteres" autocomplete="new-password">
                                    <small class="text-muted">Mínimo 8 caracteres</small>
                                </div>

                                <div class="col-md-12">
                                    <label for="confirmar_contrasena" class="col-form-label focus-label">Confirmar Contraseña:</label>
                                    <input class="form-control" type="password" id="confirmar_contrasena" name="confirmar_contrasena" minlength="8" placeholder="Confirme la contraseña" autocomplete="new-password">
                                </div>
                    ...
                    <div class="modal-body">
                        <form id="userAddForm" name="userAddForm" data-parsley-validate>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <label for="identidad_user" class="col-form-label focus-label">Identidad:<span class="text-danger">*</span></label>
                                    <input class="form-control" required type="text" pattern="[A-Za-z0-9]+" id="identidad_user" name="identidad_user" placeholder="Ingrese la identidad" data-parsley-required>
                                </div>
