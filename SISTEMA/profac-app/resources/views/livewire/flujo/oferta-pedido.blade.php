<div>
    ...
    <style>
        ...
        .of-add-btn:hover { transform:translateY(-1px); box-shadow:0 6px 18px rgba(0,184,148,.45); }
        ...
        /* Cart item rows â€” generated by JS */
        .cart-item-row {
            display:grid;
            grid-template-columns: 2fr 1fr 1.2fr 1fr 0.9fr 0.9fr 1fr 0.8fr 1fr 40px;
            gap:4px;
        ...
        @media (max-width:767px) {
            ...
            .cart-item-row {
                display:block;
                border:1px solid #e8eaef; border-radius:10px;
                margin-bottom:10px; padding:14px;
            }
            .cart-item-row [data-label]::before {
            ...
            .cart-item-row > * { margin-bottom:8px; }
        }
    ...
    <div style="background:linear-gradient(135deg,#6c5ce7 0%,#1a7efb 100%);
        ...
        <span style="color:#fff; font-size:13px;">
            ...
            Esta oferta quedarÃ¡ vinculada al
        ...
        <form onkeydown="return event.key != 'Enter';" autocomplete="off"
            ...
            <div class="of-card">
                ...
                <div class="row">
                    {{-- Fecha emisiÃ³n --}}
                    <div class="col-12 col-md-6 col-lg-3 mb-3">
                        <label class="of-label">Fecha de emisiÃ³n <span class="req">*</span></label>
                ...
                <div class="row align-items-start">
                    ...
                    <div class="col-12 col-md-5 col-lg-4 mb-3">
                        ...
                        function alSeleccionarProductoCotizacion(producto) {
                            ...
                            label.textContent = 'âœ“ ' + producto.nombre + ' (ID: ' + producto.id + ')';
                    ...
                    <div class="col-12 col-md-4 col-lg-3 mb-3">
                        <label class="of-label">CategorÃ­a precio <span class="req">*</span></label>
                        <select id="categoria_cliente_venta_id" name="categoria_cliente_venta_id"
                                class="of-select" onchange="listaCategorÃ­aClientes()">
                    ...
                    <div class="col-12 col-md-3 col-lg-3 mb-3">
                        ...
                        <select id="bodega" name="bodega" class="of-select" onchange="prueba()">
                            <option value="" selected disabled>--Seleccione categorÃ­a primero--</option>
                        </select>
                    </div>

                    {{-- Add button + product image --}}
                    <div class="col-12 col-lg-2 mb-3">
                        <label class="of-label">&nbsp;</label>
                        <div id="botonAdd" class="d-none">
                            <button type="button" class="of-add-btn" onclick="agregarProductoCarrito()">
                                <i class="fa fa-cart-plus" style="font-size:16px;"></i>
                                Agregar
                            </button>
                        </div>
                        <a id="detalleProducto" href="" class="d-none mt-2"
                           style="font-size:12px; color:#1a7efb; display:flex; align-items:center; gap:5px;"
                           target="_blank">
                    ...
                    <div class="col-12 col-md-8 col-lg-9">
                        ...
                        <div id="historialPreciosPanel" class="of-history d-none">
                            <div class="of-history-head">
                                <i class="fa fa-history mr-1"></i> Ãšltimas 5 ventas de este producto a este cliente
                            </div>
