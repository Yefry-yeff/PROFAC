<div>
    <style>
        ...
        /* ══════════════════════════════════════════════════════════════════
         * Sistema de modales unificado – Flujo Ventas  (fv-modal-*)
         * Definido aquí; aplica globalmente a todos los componentes hijos.
         * ══════════════════════════════════════════════════════════════════ */
        @keyframes fvModalIn {
        ...
        /* Tamaños de diálogo */
        .fv-dialog-sm { width: min(460px, 94vw); }
        .fv-dialog-md { width: min(620px, 94vw); }
        .fv-dialog-lg { width: min(920px, 96vw); }
        .fv-dialog-xl { width: min(1140px, 97vw); }
        ...
        .fv-modal-content {
            ...
            animation: fvModalIn .28s cubic-bezier(.34, 1.56, .64, 1) both;
        }

        /* Cabecera */
        .fv-modal-header {
            display: flex; align-items: center; justify-content: space-between;
            padding: 15px 24px; border: none; flex-shrink: 0; gap: 12px;
        }
        .fv-hdr-orange { background: linear-gradient(135deg, #f39c12 0%, #e67e22 100%); }
        .fv-hdr-blue   { background: linear-gradient(135deg, #1565c0 0%, #1a73e8 100%); }
        .fv-hdr-green  { background: linear-gradient(135deg, #00897b 0%, #00b894 100%); }
        .fv-hdr-red    { background: linear-gradient(135deg, #c62828 0%, #e53935 100%); }
        .fv-hdr-teal   { background: linear-gradient(135deg, #0097a7 0%, #00bcd4 100%); }
        .fv-hdr-purple { background: linear-gradient(135deg, #5b21b6 0%, #7c3aed 100%); }
        .fv-hdr-dark   { background: linear-gradient(135deg, #0f172a 0%, #1e3a5f 100%); }

        /* Título */
        .fv-modal-title {
            color: #fff; font-size: 16px; font-weight: 700; margin: 0; line-height: 1.3;
        }
        ...
        .fv-modal-close:hover { background: rgba(255, 255, 255, .32); }

        /* Cuerpo */
        .fv-modal-body {
            padding: 24px; overflow-y: auto; flex: 1; background: #fff;
        }
        .fv-modal-body-scroll { max-height: calc(100vh - 220px); }
        .fv-modal-body-gray   { background: #f8f9fc; }
        ...
        .fv-modal-footer-center { justify-content: center; }
    </style>
